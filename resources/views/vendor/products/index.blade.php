<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4">
                <a href="{{ route('vendor.products.create') }}" class="inline-block px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
                    + Ajouter un produit
                </a>
            </div>
                        ...
                        @forelse ($products as $product)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm space-x-2">
                                    <a href="{{ route('vendor.products.edit', $product) }}" class="text-indigo-600 hover:underline">Modifier</a>
                                    <form action="{{ route('vendor.products.destroy', $product) }}" method="POST" class="inline" onsubmit="return confirm('Supprimer ce produit ?');">
                                        @csrf
                                        @method('DELETE')
